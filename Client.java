...
public class Client implements ActionListener
{
    ...
    public Client()
    {
        ...
        JLabel photo = new JLabel(i12);
        photo.setBounds(360,20,35,30);
        p1.add(photo);
       ...
       // JPanel for below of header section
        
       p2 = new JPanel();
       p2.setBounds(5,75,425,570);
       f.add(p2);
       ...
       // this method use for exit from the program using back button
       back.addMouseListener(new MouseAdapter(){
        ...
        // this is for creating a window using awt and swing
        f.setSize(450,700);
        f.setLocation(800,5);
